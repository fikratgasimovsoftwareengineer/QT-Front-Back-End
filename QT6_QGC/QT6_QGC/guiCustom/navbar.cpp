    ...
    : QMainWindow{parent}
{
    ...
    toolbar->setIconSize(QSize(50, 50)); // Set the size of the icons
...
void navbar::setButton_Config()
{
    button3 = new QToolButton(this);
    button3->setIcon(QIcon(":/:/config.png"));
...
void navbar::setButton_Simulate()
{
    button5 = new QToolButton(this);
    button5->setIcon(QIcon(":/:/simulation.png"));
