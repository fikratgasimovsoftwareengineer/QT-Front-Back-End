...
public:
    ...
    void setupUi(QWidget *droneTypes)
    {
        if (droneTypes->objectName().isEmpty())
            droneTypes->setObjectName(QString::fromUtf8("droneTypes"));
...
"font: 13pt \"Ubuntu\";"));
        ...
        quadrator->setObjectName(QString::fromUtf8("quadrator"));
        quadrator->setGeometry(QRect(220, 70, 391, 271));
        rover = new QLabel(droneTypes);
        rover->setObjectName(QString::fromUtf8("rover"));
        rover->setGeometry(QRect(650, 70, 401, 271));
        unknown_drone_ui = new QLabel(droneTypes);
        unknown_drone_ui->setObjectName(QString::fromUtf8("unknown_drone_ui"));
...
"border-color: rgb(52, 101, 164);"));
        ...
        tricopter_y->setObjectName(QString::fromUtf8("tricopter_y"));
        tricopter_y->setGeometry(QRect(650, 420, 411, 291));
        unknown_drone_ui_2 = new QLabel(droneTypes);
        unknown_drone_ui_2->setObjectName(QString::fromUtf8("unknown_drone_ui_2"));
        ...
        uav_main_comboBox->setObjectName(QString::fromUtf8("uav_main_comboBox"));
        ...
        ugv_combo_ui->setObjectName(QString::fromUtf8("ugv_combo_ui"));
        ...
        combo_plane_ui->setObjectName(QString::fromUtf8("combo_plane_ui"));
        ...
        combo_tricopter->setObjectName(QString::fromUtf8("combo_tricopter"));
