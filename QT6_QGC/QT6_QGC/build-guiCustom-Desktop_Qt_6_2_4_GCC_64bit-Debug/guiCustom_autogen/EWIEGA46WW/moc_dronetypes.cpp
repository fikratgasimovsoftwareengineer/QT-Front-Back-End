...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_droneTypes_t, stringdata0) + ofs), len 
...
const QMetaObject droneTypes::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_droneTypes.offsetsAndSize,
