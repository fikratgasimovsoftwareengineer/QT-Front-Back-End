...
#include <memory>
#include "../../../guiCustom/signuppage.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_signuppage_t, stringdata0) + ofs), len 
...
const QMetaObject signuppage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_signuppage.offsetsAndSize,
