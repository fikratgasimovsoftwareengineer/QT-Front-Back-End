...
#include <memory>
#include "../../../guiCustom/registration.h"
...
Q_CONSTINIT static const qt_meta_stringdata_registration_t qt_meta_stringdata_registration = {
    {
        ...
        QT_MOC_LITERAL(13, 10),  // "signUPTest"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 9),  // "loginTest"
        QT_MOC_LITERAL(35, 21),  // "signInUIButtonClicked"
        QT_MOC_LITERAL(57, 21)   // "signUPUIButtonClicked"
    },
    "registration",
    "signUPTest",
    "",
    "loginTest",
    "signInUIButtonClicked",
    "signUPUIButtonClicked"
};
...
Q_CONSTINIT const QMetaObject registration::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_registration_t,
        ...
        // method 'loginTest'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signInUIButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signUPUIButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void registration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signUPTest(); break;
        case 1: _t->loginTest(); break;
        case 2: _t->signInUIButtonClicked(); break;
        case 3: _t->signUPUIButtonClicked(); break;
        default: ;
        }
    }
    (void)_a;
